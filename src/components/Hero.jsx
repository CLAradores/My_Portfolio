      ...
      <main className="lg:max-w-screen-xl  container mx-auto --text-color">
        ...
        >
          <div className=" w-screen lg:w-3/4 mx-auto">
            ...
            <h2 className="text-5xl font-extrabold leading-10 my-5">
            ...
            <div className="mt-8 ">
              <a
                href="#"
                className="py-3 px-5 mt-10 --bg-primary --text-secodary rounded-full font-semibold border --button-cv"
              >
                Download CV
              </a>
            </div>
          ...
          <div>
            <img className="lg:block hidden " src={heroPic} alt="Profile Pic" />
          </div>
        </div>
      </main>
    </div>
